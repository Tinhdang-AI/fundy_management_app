  ...
  Widget _buildSummarySection() {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildSummaryItem('Chi tiêu', '${formatCurrency.format(_expenseTotal)}đ', Colors.blue.shade100),
          _buildSummaryItem('Thu nhập', '${formatCurrency.format(_incomeTotal)}đ', Colors.pink.shade100),
          _buildSummaryItem(
              'Chênh lệch',
              '${_netTotal >= 0 ? '' : '-'}${formatCurrency.format(_netTotal.abs())}đ',
